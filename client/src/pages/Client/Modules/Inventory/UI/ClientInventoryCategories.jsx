...
import { Archive, Edit3, Layers3, Plus } from "lucide-react";

export default function ClientInventoryCategories({
  data,
  onCreateCategory,
  onEditCategory,
  onArchiveCategory,
      ...
      <div className="flex flex-col gap-4 border-b border-slate-200 p-5 dark:border-slate-800 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
            Manage inventory groups used to organize workspace items.
          </p>
        </div>
      ...
      {categories.length === 0 ? (
        <div className="flex flex-col items-center justify-center px-6 py-16 text-center">
          ...
          <p className="mt-2 max-w-md text-sm text-slate-500 dark:text-slate-400">
            Create categories like Accessories, Mobile Phones, Pizza, Bread, or
            Services before adding inventory items.
          </p>
        </div>
      ) : (
