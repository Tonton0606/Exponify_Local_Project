...
export function ContactsKPICards({ contacts }) {
  ...
  const cards = [
    { label: "Total Contacts", value: total, helper: "All contact records", icon: Users, tone: "text-[var(--brand-gold)]" },
    { label: "Companies", value: companies, helper: "Company-type contacts", icon: Building2, tone: "text-[var(--text-primary)]" },
    { label: "Customers", value: customers, helper: "Active customers", icon: UserRound, tone: "text-[var(--success)]" },
    { label: "Leads", value: leads, helper: "Unqualified leads", icon: Users, tone: "text-[var(--brand-gold)]" },
    { label: "Prospects", value: prospects, helper: "Engaged prospects", icon: Search, tone: "text-[var(--brand-cyan)]" },
    { label: "Recently Added", value: recent, helper: "Added in last 30 days", icon: Plus, tone: "text-[var(--success)]" },
  ];
              ...
              <td className="px-4 py-3">
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="rounded-xl border border-[var(--brand-gold-border)] bg-[var(--brand-gold-soft)] p-2 text-[var(--brand-gold)] transition hover:opacity-80"
                    title="Edit"
                  >
                  ...
                  <button
                    ...
                    className="rounded-xl border border-[var(--brand-cyan-border)] bg-[var(--brand-cyan-soft)] p-2 text-[var(--brand-cyan)] transition hover:opacity-80"
                    title="Create Deal"
                  >
...
export function ContactDetailDrawer({
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end bg-black/30" onClick={onClose}>
      <div className="h-full w-full max-w-xl bg-[var(--bg-card)] shadow-2xl" onClick={(event) => event.stopPropagation()}>
        ...
        <div className="flex justify-end gap-2 border-t border-[var(--border-color)] bg-[var(--hover-bg)] p-4">
          ...
          <button
            type="button"
            onClick={() => onCreateDeal?.(contact)}
            className="rounded-2xl border border-[var(--brand-cyan-border)] bg-[var(--brand-cyan-soft)] px-4 py-2 text-sm font-semibold text-[var(--brand-cyan)] transition hover:opacity-80"
          >
            Create Deal
          </button>
          <button
